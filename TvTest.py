...
class NetLocdFrame(wx.Frame):
    def __init__(self):
        ...
        wx.Frame.__init__(self, None, title="加载网络检测配置", size=(510,500))
...
class MainWindow(wx.Frame):
    ...
    def NetConf(self, tid):
        print self.netconfid
        AcRe = urllib2.Request(r'http://192.168.79.188/cgi/tvtest/LE42H300.php?tid=%i&t=%i' % (self.netconfid, time.time()))
